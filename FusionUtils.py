...
def build_fused_object(list_of_2d_objects, list_of_3d_objects, matches, image):
    ...
    for match in matches:
        ...
        #optimal_box = find_optimal_box([lidarbox],  [camerabox])
        #cv2.rectangle(img, optimal_box, (0,255,0), 2)                           
...
def merge_boxes(box1, box2):
    """
    Combina dos cajas en una nueva caja que englobe ambas detecciones.
...
def find_optimal_box(lidar_boxes, camera_boxes):
    merged_box = None
    
    # Combinar todas las cajas de LiDAR y cámara en una sola caja
